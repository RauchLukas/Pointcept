...
from pointcept.utils.writer import WandBWriter
...
class Trainer(TrainerBase):
    def __init__(self, cfg):
        ...
        self.logger.info("=> Building wandb writer ...")
        self.wandb_writer = self.build_wandb_writer()
